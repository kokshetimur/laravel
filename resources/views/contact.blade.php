...
<nav class="nav nav-underline justify-content-between">
    ...
    <a class="nav-item nav-link link-body-emphasis mx-2" href="about">about</a>
...
<button type="submit" class="btn btn-success"> Отправить. Send </button>
